			...
			if preprocess_clash_yaml(upload_tmp_path, tmp_output) then
				...
				if hash == "" then
					...
					if sid then
						...
						local redirect_message_url = redirect_url .. "?upload_message=" .. luci.http.urlencode(message)
	...
	o.description = translate(
		...
		"<script type='text/javascript'>" ..
			"(function() {" ..
				...
				"var linkText = " .. luci.util.serialize_json(translate("Click here to manage")) .. ";" ..
