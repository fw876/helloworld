...
if Process_list:find("/usr/bin/mosdns") or Process_list:find("ssrplus/bin/pdnsd") or (Process_list:find("ssrplus.dns") and Process_list:find("dns2socks.127.0.0.1.*127.0.0.1.5335")) then
	pdnsd_run = 1
end
...
s = m:field(DummyValue, "mosdns", translate("GeoIP List Data"))
s.rawhtml = true
s.template = "shadowsocksr/refresh"
s.value = translate("No Check")
